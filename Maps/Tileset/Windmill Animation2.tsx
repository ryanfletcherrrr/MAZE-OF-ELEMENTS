...
<tileset name="Windmill_Animation2" tilewidth="32" tileheight="32" tilecount="400" columns="8">
 <image source="Windmill Animation2.png" width="256" height="1600"/>
 <tile id="0">
  <animation>
