...
public class GUI {
    ...
    private void updateStudent() {
        ...
        // Replace the panel with a new panel
        main.add(new JLabel("Update Student Form Coming Soon", SwingConstants.CENTER), BorderLayout.CENTER);
        ...
        idBtn.addActionListener(e -> {
            ...
            try {
                ...
                if (s != null) {
                    ...
                    sb.append("Primary Course: ").append(s.getCourse()).append("\n");
        ...
        if (students.isEmpty()) {
            ...
            for (main.model.Student s : students.values()) {
                sb.append(String.format("%-10d %-15s %-15s %-20s\n",
                        ...
                        s.getFirstName(),
                        s.getLastName(),
                        s.getCourse() // or s.getPrimaryCourse()
                ));
            }
        }
    ...
    private void removeStudent() {
        ...
        // Replace the panel with a new panel
        main.add(new JLabel("Remove Student Form Coming Soon", SwingConstants.CENTER), BorderLayout.CENTER);
